...
class MegaD26:
    ...
    def learn_and_save(self, timestep, iterations, hyps):
        self.counter += 1
        ...
        # hyps = PPO_HypConfig.request_next_HypConfig(self.env_name, logdir+"//")
